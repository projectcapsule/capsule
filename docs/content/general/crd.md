...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#tenantspecpodoptions-1">podOptions</a></b></td>
        <td>object</td>
        <td>
          Specifies options for the Pod, such as additional metadata. Optional.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
Specifies options for the Pod, such as additional metadata. Optional.
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#tenantspecpodoptionsadditionalmetadata-1">additionalMetadata</a></b></td>
        <td>object</td>
        <td>
