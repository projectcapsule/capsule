...
func TestApprovalSpecIsApprover(t *testing.T) {
	...
	tests := []struct {
		name     string
		spec     resourcepermit.ApprovalSpec
		username string
		groups   []string
		want     bool
	}{
		...
		{
			name:     "user",
			spec:     resourcepermit.ApprovalSpec{Approvers: rbac.UserListSpec{{Kind: rbac.UserOwner, Name: "alice"}}},
			username: "alice",
			want:     true,
		},
		{
			name:     "group",
			spec:     resourcepermit.ApprovalSpec{Approvers: rbac.UserListSpec{{Kind: rbac.GroupOwner, Name: "on-call"}}},
			username: "alice",
		...
		},
		{
			...
			spec: resourcepermit.ApprovalSpec{Approvers: rbac.UserListSpec{{
