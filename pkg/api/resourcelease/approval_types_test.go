...
func TestApprovalSpecIsApprover(t *testing.T) {
	...
	tests := []struct {
		name     string
		spec     resourcelease.ApprovalSpec
		username string
		groups   []string
		want     bool
	}{
		...
		{
			name:     "user",
			spec:     resourcelease.ApprovalSpec{Approvers: rbac.UserListSpec{{Kind: rbac.UserOwner, Name: "alice"}}},
			username: "alice",
			want:     true,
		},
		{
			name:     "group",
			spec:     resourcelease.ApprovalSpec{Approvers: rbac.UserListSpec{{Kind: rbac.GroupOwner, Name: "on-call"}}},
			username: "alice",
		...
		},
		{
			...
			spec: resourcelease.ApprovalSpec{Approvers: rbac.UserListSpec{{
