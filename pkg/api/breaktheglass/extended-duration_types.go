...
// ExtendedDuration is a custom duration field type that supports weeks, days, hours, minutes and seconds.
...
// String returns the duration formatted as an extended duration string.
