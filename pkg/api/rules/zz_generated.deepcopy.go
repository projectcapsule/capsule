...
func (in *FieldRule) DeepCopyInto(out *FieldRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FieldRule.
func (in *FieldRule) DeepCopy() *FieldRule {
	if in == nil {
		return nil
	}
	out := new(FieldRule)
