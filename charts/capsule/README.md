...
| manager.options.leaderElectionLeaseDuration | string | `""` | Leader election lease duration. Empty uses controller-runtime's default. |
| manager.options.leaderElectionRenewDeadline | string | `""` | Leader election renew deadline. Empty uses controller-runtime's default. |
| manager.options.leaderElectionRetryPeriod | string | `""` | Leader election retry period. Empty uses controller-runtime's default. |
