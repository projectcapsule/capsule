...
| webhooks.hooks.generic.freeze.enabled | bool | `true` |  |
| webhooks.hooks.generic.freeze.failurePolicy | string | `"Fail"` |  |
| webhooks.hooks.generic.freeze.matchPolicy | string | `"Equivalent"` |  |
| webhooks.hooks.generic.freeze.namespaceSelector | object | `{}` |  |
| webhooks.hooks.generic.freeze.objectSelector.matchLabels."projectcapsule.dev/freeze" | string | `"true"` |  |
| webhooks.hooks.generic.freeze.reinvocationPolicy | string | `"Never"` |  |
| webhooks.hooks.generic.freeze.rules[0].apiGroups[0] | string | `"*"` |  |
| webhooks.hooks.generic.freeze.rules[0].apiVersions[0] | string | `"*"` |  |
| webhooks.hooks.generic.freeze.rules[0].operations[0] | string | `"CREATE"` |  |
| webhooks.hooks.generic.freeze.rules[0].operations[1] | string | `"UPDATE"` |  |
| webhooks.hooks.generic.freeze.rules[0].operations[2] | string | `"DELETE"` |  |
| webhooks.hooks.generic.freeze.rules[0].resources[0] | string | `"*"` |  |
| webhooks.hooks.generic.freeze.rules[0].scope | string | `"Namespaced"` |  |
...
| webhooks.hooks.resource.claims.failurePolicy | string | `"Fail"` |  |
| webhooks.hooks.resource.claims.matchPolicy | string | `"Equivalent"` |  |
| webhooks.hooks.resource.claims.namespaceSelector | object | `{}` |  |
| webhooks.hooks.resource.claims.objectSelector | object | `{}` |  |
| webhooks.hooks.resource.claims.reinvocationPolicy | string | `"Never"` |  |
| webhooks.hooks.resource.pools.failurePolicy | string | `"Fail"` |  |
| webhooks.hooks.resource.pools.matchPolicy | string | `"Equivalent"` |  |
| webhooks.hooks.resource.pools.namespaceSelector | object | `{}` |  |
| webhooks.hooks.resource.pools.objectSelector | object | `{}` |  |
| webhooks.hooks.resource.pools.reinvocationPolicy | string | `"Never"` |  |
