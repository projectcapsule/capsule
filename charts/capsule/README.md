...
| manager.options.leaderElectionLeaseDuration | string | `"45s"` | Leader election lease duration. Empty uses controller-runtime's default. |
| manager.options.leaderElectionRenewDeadline | string | `"30s"` | Leader election renew deadline. Empty uses controller-runtime's default. |
| manager.options.leaderElectionRetryPeriod | string | `"5s"` | Leader election retry period. Empty uses controller-runtime's default. |
