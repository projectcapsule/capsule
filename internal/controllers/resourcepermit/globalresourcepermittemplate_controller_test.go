...
func TestGlobalResourcePermitTemplateReconciler(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := &capsulev1beta2.GlobalResourcePermitTemplate{}
...
func TestGlobalResourcePermitTemplateStatusNamespacePresent(t *testing.T) {
	t.Parallel()

	selected := capsulev1beta2.GlobalResourcePermitTemplateStatus{Namespaces: []string{"team-a"}}
	...
	unrestricted := capsulev1beta2.GlobalResourcePermitTemplateStatus{Namespaces: []string{"*"}}
