...
//nolint:dupl
func (h *globalCustomQuotaValidationHandler) OnCreate(
	_ client.Client,
	_ client.Reader,
...
func (h *globalCustomQuotaValidationHandler) OnDelete(
	_ client.Client,
	_ client.Reader,
	decoder admission.Decoder,
	_ events.EventRecorder,
	...
	return func(_ context.Context, req admission.Request) *admission.Response {
		...
		key := controller.MakeGlobalCustomQuotaCacheKey(obj.GetName())
...
//nolint:dupl
func (h *globalCustomQuotaValidationHandler) OnUpdate(
	_ client.Client,
	_ client.Reader,
	decoder admission.Decoder,
	_ events.EventRecorder,
