...
func TestGlobalResourcePermitTemplateValidationHandler(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			brt: &capsulev1beta2.GlobalResourcePermitTemplate{
				Spec: capsulev1beta2.GlobalResourcePermitTemplateSpec{
					Approvals: resourcepermit.ApprovalSpec{Approvers: rbac.UserListSpec{{Kind: rbac.UserOwner}}},
					Resources: []apiruntime.ResourceTemplate{{Targets: []runtime.RawExtension{{Object: &corev1.ConfigMap{}}}}},
				},
			},
			expected: http.StatusForbidden,
		...
		},
		{
			...
			brt: &capsulev1beta2.GlobalResourcePermitTemplate{Spec: capsulev1beta2.GlobalResourcePermitTemplateSpec{
