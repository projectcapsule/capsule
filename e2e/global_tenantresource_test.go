...
var _ = Describe("Creating a GlobalTenantResource object", Label("global", "tenantresource"), func() {
	...
	JustAfterEach(func() {
		EventuallyDeletion(solar)
		EventuallyDeletion(wind)
		EventuallyDeletion(gtr)
		EventuallyDeletion(namespacedItem)
