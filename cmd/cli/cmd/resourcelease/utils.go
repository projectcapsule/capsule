...
func printResourceLeasesApprovalTable(
	br *capsulev1beta2.ResourceLease,
	app *capsulev1beta2.ResourceLeaseStatusRequest,
	color bool,
) {
	t := table.NewWriter()
...
func runResourceLeaseAction(phase capsulev1beta2.ResourceLeasePhase) error {
