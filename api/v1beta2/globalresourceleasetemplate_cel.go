...
func (brt *GlobalResourceLeaseTemplate) ValidateApprovalConditions() error {
...
func (brt *ResourceLeaseTemplate) ValidateApprovalConditions() error {
	return validateApprovalConditions(brt.Spec.Approvals)
}

func validateApprovalConditions(approvals resourcelease.ApprovalSpec) error {
...
// a ResourceLease and its requestor/reviewer identities. Conditions are ORed.
func (brt *GlobalResourceLeaseTemplate) EvaluateApprovalConditions(
	ctx context.Context,
	br *ResourceLease,
) (bool, error) {
...
func (brt *ResourceLeaseTemplate) EvaluateApprovalConditions(
	ctx context.Context,
	br *ResourceLease,
) (bool, error) {
	return evaluateApprovalConditions(ctx, br, brt.Spec.Approvals)
...
func (br *ResourceLease) ApprovalPolicy(fallback ResourceLeaseTemplateSource) resourcelease.ApprovalSpec {
	...
	return resourcelease.ApprovalSpec{}
}
...
func (br *ResourceLease) EvaluateApprovalConditions(
	ctx context.Context,
	fallback ResourceLeaseTemplateSource,
) (bool, error) {
...
func evaluateApprovalConditions(
	...
	if err != nil {
		return false, fmt.Errorf("convert ResourceLease for approval condition: %w", err)
	}
...
func (brt *GlobalResourceLeaseTemplate) CheckApprovalConditions(ctx context.Context, br *ResourceLease) error {
...
func (brt *ResourceLeaseTemplate) CheckApprovalConditions(ctx context.Context, br *ResourceLease) error {
	return checkApprovalConditions(ctx, br, brt.Spec.Approvals)
}

// CheckApprovalConditions checks the approval policy captured with the
// request, falling back to the supplied template for legacy requests.
func (br *ResourceLease) CheckApprovalConditions(
	ctx context.Context,
	fallback ResourceLeaseTemplateSource,
) error {
