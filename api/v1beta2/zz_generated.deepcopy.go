...
func (in *CapsuleConfigurationSpec) DeepCopyInto(out *CapsuleConfigurationSpec) {
	*out = *in
	...
	if in.ServiceAccountClient != nil {
		in, out := &in.ServiceAccountClient, &out.ServiceAccountClient
		*out = new(api.ServiceAccountClient)
		**out = **in
	}
}
...
func (in *ObjectReferenceStatus) DeepCopyInto(out *ObjectReferenceStatus) {
	*out = *in
	in.ResourceIDWithOptions.DeepCopyInto(&out.ResourceIDWithOptions)
	out.ObjectReferenceStatusCondition = in.ObjectReferenceStatusCondition
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceIDWithOptions) DeepCopyInto(out *ResourceIDWithOptions) {
	*out = *in
	out.ResourceID = in.ResourceID
	if in.ResourceSpecSettings != nil {
		in, out := &in.ResourceSpecSettings, &out.ResourceSpecSettings
		*out = new(ResourceSpecSettings)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceIDWithOptions.
func (in *ResourceIDWithOptions) DeepCopy() *ResourceIDWithOptions {
	if in == nil {
		return nil
	}
	out := new(ResourceIDWithOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceSpec) DeepCopyInto(out *ResourceSpec) {
	*out = *in
	...
	if in.NamespacedItems != nil {
		...
		*out = make([]misc.ResourceReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceSpecSettings) DeepCopyInto(out *ResourceSpecSettings) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceSpecSettings.
func (in *ResourceSpecSettings) DeepCopy() *ResourceSpecSettings {
	if in == nil {
		return nil
	}
	out := new(ResourceSpecSettings)
...
func (in *TenantResourceSpec) DeepCopyInto(out *TenantResourceSpec) {
	*out = *in
	in.ReplicationSettings.DeepCopyInto(&out.ReplicationSettings)
	if in.Resources != nil {
