...
func (in *GlobalResourceQuotaSpec) DeepCopyInto(out *GlobalResourceQuotaSpec) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make(map[api.Name]corev1.ResourceQuotaSpec, len(*in))
...
func (in *GlobalResourceQuotaStatus) DeepCopyInto(out *GlobalResourceQuotaStatus) {
	*out = *in
	...
	if in.Quota != nil {
		...
		*out = make(GlobalResourceQuotaStatusQuota, len(*in))
		for key, val := range *in {
			var outVal *corev1.ResourceQuotaStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in GlobalResourceQuotaStatusQuota) DeepCopyInto(out *GlobalResourceQuotaStatusQuota) {
	{
		in := &in
		*out = make(GlobalResourceQuotaStatusQuota, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalResourceQuotaStatusQuota.
func (in GlobalResourceQuotaStatusQuota) DeepCopy() GlobalResourceQuotaStatusQuota {
	if in == nil {
		return nil
	}
	out := new(GlobalResourceQuotaStatusQuota)
	in.DeepCopyInto(out)
	return *out
}
