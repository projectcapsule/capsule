...
func (in *CustomQuotaStatus) DeepCopyInto(out *CustomQuotaStatus) {
	*out = *in
	...
	if in.Claims != nil {
		...
		*out = make([]meta.NamespacedObjectWithUIDReference, len(*in))
		copy(*out, *in)
	}
...
func (in *CustomQuotaStatusTarget) DeepCopyInto(out *CustomQuotaStatusTarget) {
	*out = *in
	out.CustomQuotaSpecSource = in.CustomQuotaSpecSource
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PromotionRule) DeepCopyInto(out *PromotionRule) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PromotionRule.
func (in *PromotionRule) DeepCopy() *PromotionRule {
	if in == nil {
		return nil
	}
