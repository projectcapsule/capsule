...
func (brt *GlobalResourcePermitTemplate) ValidateApprovalConditions() error {
...
func (brt *ResourcePermitTemplate) ValidateApprovalConditions() error {
	return validateApprovalConditions(brt.Spec.Approvals)
}

func validateApprovalConditions(approvals resourcepermit.ApprovalSpec) error {
...
func (brt *ResourcePermitTemplate) EvaluateApprovalConditions(
	ctx context.Context,
	br *ResourcePermit,
) (bool, error) {
	return evaluateApprovalConditions(ctx, br, brt.Spec.Approvals)
...
func (br *ResourcePermit) ApprovalPolicy(fallback ResourcePermitTemplateSource) resourcepermit.ApprovalSpec {
	...
	return resourcepermit.ApprovalSpec{}
}
...
func (br *ResourcePermit) EvaluateApprovalConditions(
	ctx context.Context,
	fallback ResourcePermitTemplateSource,
) (bool, error) {
...
func (brt *GlobalResourcePermitTemplate) CheckApprovalConditions(ctx context.Context, br *ResourcePermit) error {
...
func (brt *ResourcePermitTemplate) CheckApprovalConditions(ctx context.Context, br *ResourcePermit) error {
	return checkApprovalConditions(ctx, br, brt.Spec.Approvals)
}

// CheckApprovalConditions checks the approval policy captured with the
// request, falling back to the supplied template for legacy requests.
func (br *ResourcePermit) CheckApprovalConditions(
	ctx context.Context,
	fallback ResourcePermitTemplateSource,
) error {
